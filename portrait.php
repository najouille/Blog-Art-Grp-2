  ...
  <link rel="stylesheet" href="./front/assets/portrait.css" />
    ...
    <?php include('./front/includes/commons/navbar.php')?>
      <section class="introduction">
        ...
        <p id="intro">
          En 2014,
          <a href="https://www.fredericducos.com/" target="_blank">Frédéric Ducos</a>
          a choisi de quitter le milieu du vin pour rejoindre celui de la
          photographie. Une reconversion, on peut le dire, réussie ! En effet,
          quelques années plus tard, il remporte le
          <a href="https://www.umbrawards.com/" target="_blank"
            >Umbra International Photography Awards</a
          >, un concours de renommée mondiale. Pourtant, à première vue, le pari
      ...
      <div class="bandeau">
        ...
        <h2>
          “La photographie est l’expression d’émotions par la recherche d’un
          certain minimalisme”
        </h2>
        <div class="quote">
      ...
      <section class="article">
        <h3>Le désir de créer et de partager</h3>
        <p>
        ...
        <p>
          ...
          à l’<a href="https://whc.unesco.org/fr/list/1256/" target="blank"
            >UNESCO</a
          >
          qui l’entourent. Le tramway offre également l’occasion de mêler
          l’architecture à la vie quotidienne bordelaise.
        </p>
        <h3>La démarche artistique : capturer l’instant présent</h3>
        <p>
        ...
        <h3>Un minimalisme au service de l’émotion</h3>
        <p>
        ...
        <div class="social">
          ...
          <a
            class="social-button"
            href="https://www.fredericducos.com"
            target="blank"
          >
            <svg
              width="44"
            ...
            >
              <path
                d="M22 38.5c9.113 0 16.5-7.387 16.5-16.5S31.113 5.5 22 5.5 5.5 12.887 5.5 22 12.887 38.5 22 38.5zM6.6 16.5h30.8M6.6 27.5h30.8M21.083 5.5a31.166 31.166 0 000 33M22.916 5.5a31.167 31.167 0 010 33"
                stroke="currentColor"
                stroke-width="2.75"
                stroke-linecap="round"
                stroke-linejoin="round"
