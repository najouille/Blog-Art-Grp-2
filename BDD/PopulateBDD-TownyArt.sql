INSERT INTO
    `angle` (`numAngl`, `libAngl`, `numLang`)
VALUES
    ('ANGL0001', 'Street-Art', 'FRAN01');

INSERT INTO
    `motcle` (`numMotCle`, `libMotCle`, `numLang`)
VALUES
    (NULL, 'architecture', 'FRAN01'),
    (NULL, 'urbain', 'FRAN01'),
    (NULL, 'art', 'FRAN01'),
    (NULL, 'évènement', 'FRAN01'),
    (NULL, 'insolite', 'FRAN01'),
    (NULL, 'street-art  ', 'FRAN01'),
    (NULL, 'photographie', 'FRAN01');
...
VALUES
    (
        ...
        NULL,
        `/front/assets/image/jon-tyson-HuRTqaEMD4I-unsplash 1.png`,
        `ANGL0001`,
        `THE0101`
    );
...
VALUES
    (
        ...
        "/front/assets/image/portaitphotographe.png`,
        "ANGL0001`,
        "THE0102`
    );